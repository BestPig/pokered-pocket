roms := pokered.pocket pokeblue.pocket pokeblue_debug.pocket
...
tidy:
	rm -f $(roms) $(pokered_obj) $(pokeblue_obj) $(pokeblue_debug_obj) $(roms:.pocket=.map) $(roms:.pocket=.sym) rgbdscheck.o
	$(MAKE) clean -C tools/
